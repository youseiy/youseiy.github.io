...
const CONFIG = {
  github: {
    username: 'youseiy', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['youseiy/DataStructures','youseiy/AttachmentSyncPlugin','youseiy/ChessUnreal'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  seo: {
    title: 'Portfolio of Matheus Almeida',
    description: '',
    imageURL: '',
  },
  social: {
